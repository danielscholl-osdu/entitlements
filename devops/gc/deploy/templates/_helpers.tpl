...
{{- define "entitlements.getAutoscaling" -}}
...
{{- define "entitlements.minReplicasSpot" -}}
{{- $tier := include "entitlements.getTier" . -}}
...
{{- define "entitlements.maxReplicasSpot" -}}
{{- $tier := include "entitlements.getTier" . -}}
...
{{- define "entitlements.replicasStandard" -}}
{{- $tier := include "entitlements.getTier" . -}}
