...
@ComponentScan(value = {
    ...
    @ComponentScan.Filter(
        ...
        value = {IDTokenValidatorConfig.class, ExternalAuthConfiguration.class, InternalAuthConfiguration.class}
    )
})
@Configuration
public class AuthTestConfig {
    ...
    public IDTokenValidator getIapValidator() throws MalformedURLException {
        return new IDTokenValidator(new Issuer("testIssuerId"),
