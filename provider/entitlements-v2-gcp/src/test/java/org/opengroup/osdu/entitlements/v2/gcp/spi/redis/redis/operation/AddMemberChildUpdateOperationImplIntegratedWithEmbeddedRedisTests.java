...
public class AddMemberChildUpdateOperationImplIntegratedWithEmbeddedRedisTests {
    ...
    @Test
    public void should_throw409_whenUpdateChildren_andConflict() {
        StatefulRedisConnection<String, String> connection = dp1RedisClient.connect();
        RedisCommands<String, String> commands = connection.sync();
    ...
    public void should_revertChanges_whenUndo_singlePartition() throws Exception {
        ...
        commands.select(config.getPartitionParentRefDb());
        addMemberChildUpdateOperation.execute();
        assertFalse(commands.smembers("users.y@dp1.domain.com").isEmpty());
    ...
    public void should_revertChanges_whenUndo_crossPartition() throws Exception {
        ...
        commands1.select(config.getPartitionParentRefDb());
        addMemberChildUpdateOperation.execute();
        assertFalse(commands1.smembers("users.y@dp1.domain.com").isEmpty());
        addMemberChildUpdateOperation.undo();
