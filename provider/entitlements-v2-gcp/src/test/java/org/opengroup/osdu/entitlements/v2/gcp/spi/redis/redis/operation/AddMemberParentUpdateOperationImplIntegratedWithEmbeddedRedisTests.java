...
public class AddMemberParentUpdateOperationImplIntegratedWithEmbeddedRedisTests {
    ...
    @Test
    public void should_updateAllParents_whenExecute_singlePartition() throws Exception {
        StatefulRedisConnection<String, String> connection = dp1RedisClient.connect();
        RedisCommands<String, String> commands = connection.sync();
    ...
    public void should_revertChanges_whenUndo_singlePartition() throws Exception {
        ...
        commands.select(config.getPartitionChildrenRefDb());
        addMemberParentUpdateOperation.execute();
        assertFalse(commands.smembers("users.x@dp1.domain.com").isEmpty());
        addMemberParentUpdateOperation.undo();
        assertTrue(commands.smembers("users.x@dp1.domain.com").isEmpty());
    }

    @Test
    public void should_updateAllParents_whenExecute_crossPartition() throws Exception {
    ...
    public void should_revertChanges_whenUndo_crossPartition() throws Exception {
        ...
        commands2.select(config.getPartitionChildrenRefDb());
        addMemberParentUpdateOperation.execute();
        assertFalse(commands2.smembers("users.x@dp2.domain.com").isEmpty());
        addMemberParentUpdateOperation.undo();
